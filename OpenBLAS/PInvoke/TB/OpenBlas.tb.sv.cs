...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "stbsv")]
    ...
    /// <param name="x">Pointer to the right-hand side vector.</param>
    /// <param name="incX">Pointer to the increment for the elements of the vector x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "dtbsv")]
    ...
    /// <param name="x">Pointer to the right-hand side vector.</param>
    /// <param name="incX">Pointer to the increment for the elements of the vector x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ctbsv")]
    internal static extern void Ctbsv(sbyte* uplo, sbyte* trans, sbyte* diag, int* n, int* k, ComplexFloat* a, int* lda, ComplexFloat* x, int* incX);
    ...
    /// <param name="x">Pointer to the right-hand side vector.</param>
    /// <param name="incX">Pointer to the increment for the elements of the vector x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ztbsv")]
    internal static extern void Ztbsv(sbyte* uplo, sbyte* trans, sbyte* diag, int* n, int* k, ComplexDouble* a, int* lda, ComplexDouble* x, int* incX);
}
