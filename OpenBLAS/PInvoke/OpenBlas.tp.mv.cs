...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "stpmv_")]
    ...
    /// <param name="x">Pointer to the vector to be multiplied.</param>
    /// <param name="incX">Pointer to the increment for the elements of the vector x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "dtpmv_")]
    ...
    /// <param name="x">Pointer to the vector to be multiplied.</param>
    /// <param name="incX">Pointer to the increment for the elements of the vector x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ctpmv_")]
    internal static extern void Ctpmv(sbyte* uplo, sbyte* trans, sbyte* diag, int* n, float* ap, float* x, int* incX);
    ...
    /// <param name="x">Pointer to the vector to be multiplied.</param>
    /// <param name="incX">Pointer to the increment for the elements of the vector x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ztpmv_")]
    internal static extern void Ztpmv(sbyte* uplo, sbyte* trans, sbyte* diag, int* n, double* ap, double* x, int* incX);
}
