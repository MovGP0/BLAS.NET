...
internal static unsafe partial class OpenBlas
{
    ...
    internal static extern void Cgemm(sbyte* transA, sbyte* transB, int* m, int* n, int* k, ComplexFloat* alpha, ComplexFloat* a, int* lda, ComplexFloat* b, int* ldb, ComplexFloat* beta, ComplexFloat* c, int* ldc);
    ...
    internal static extern void Zgemm(sbyte* transA, sbyte* transB, int* m, int* n, int* k, ComplexDouble* alpha, ComplexDouble* a, int* lda, ComplexDouble* b, int* ldb, ComplexDouble* beta, ComplexDouble* c, int* ldc);
}
