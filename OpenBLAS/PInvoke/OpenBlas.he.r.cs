...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "cher_")]
    internal static extern void Cher(sbyte* uplo, int* n, float* alpha, float* x, int* incX, float* a, int* lda);
    ...
    /// <param name="lda">Pointer to the leading dimension of the matrix A.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "zher_")]
    internal static extern void Zher(sbyte* uplo, int* n, double* alpha, double* x, int* incX, double* a, int* lda);
}
