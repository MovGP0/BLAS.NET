...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "sgetrs_")]
    ...
    /// <param name="info">Pointer to the output information. If info = 0, the execution is successful.</param>
    /// <returns>Returns 0 if the execution is successful.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "dgetrs_")]
    ...
    /// <param name="info">Pointer to the output information. If info = 0, the execution is successful.</param>
    /// <returns>Returns 0 if the execution is successful.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "cgetrs_")]
    ...
    /// <param name="info">Pointer to the output information. If info = 0, the execution is successful.</param>
    /// <returns>Returns 0 if the execution is successful.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "zgetrs_")]
