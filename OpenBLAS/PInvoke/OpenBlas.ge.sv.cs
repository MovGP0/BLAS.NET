...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "sgesv_")]
    ...
    /// <param name="info">Pointer to the output information. If info = 0, the execution is successful. If info &gt; 0, the matrix A is singular.</param>
    /// <returns>Returns 0 if the execution is successful, or a positive integer if the matrix A is singular.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "dgesv_")]
    ...
    /// <param name="info">Pointer to the output information. If info = 0, the execution is successful. If info &gt; 0, the matrix A is singular.</param>
    /// <returns>Returns 0 if the execution is successful, or a positive integer if the matrix A is singular.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "cgesv_")]
    ...
    /// <param name="info">Pointer to the output information. If info = 0, the execution is successful. If info &gt; 0, the matrix A is singular.</param>
    /// <returns>Returns 0 if the execution is successful, or a positive integer if the matrix A is singular.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "zgesv_")]
