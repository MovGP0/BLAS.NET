...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl , EntryPoint = "spotrf_")]
    ...
    /// <param name="info">Pointer to the output info parameter.</param>
    /// <returns>Returns an integer indicating the success of the operation.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl , EntryPoint = "dpotrf_")]
    ...
    /// <param name="info">Pointer to the output info parameter.</param>
    /// <returns>Returns an integer indicating the success of the operation.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl , EntryPoint = "cpotrf_")]
    ...
    /// <param name="info">Pointer to the output info parameter.</param>
    /// <returns>Returns an integer indicating the success of the operation.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl , EntryPoint = "zpotrf_")]
