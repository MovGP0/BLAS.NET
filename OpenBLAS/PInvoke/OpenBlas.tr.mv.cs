...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "strmv_")]
    ...
    /// <param name="x">Pointer to the vector to be multiplied.</param>
    /// <param name="incX">Pointer to the increment for the elements of the vector x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "dtrmv_")]
    ...
    /// <param name="x">Pointer to the vector to be multiplied.</param>
    /// <param name="incX">Pointer to the increment for the elements of the vector x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ctrmv_")]
    internal static extern void C_tr_mv(sbyte* uplo, sbyte* trans, sbyte* diag, int* n, float* a, int* lda, float* x, int* incX);
    ...
    /// <param name="x">Pointer to the vector to be multiplied.</param>
    /// <param name="incX">Pointer to the increment for the elements of the vector x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ztrmv_")]
    internal static extern void Z_tr_mv(sbyte* uplo, sbyte* trans, sbyte* diag, int* n, double* a, int* lda, double* x, int* incX);
}
