...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "strsm")]
    ...
    /// <param name="B">Pointer to the matrix B.</param>
    /// <param name="ldb">Pointer to the leading dimension of the matrix B.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "dtrsm")]
    ...
    /// <param name="B">Pointer to the matrix B.</param>
    /// <param name="ldb">Pointer to the leading dimension of the matrix B.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ctrsm")]
    internal static extern void C_tr_sm(sbyte* side, sbyte* uplo, sbyte* transa, sbyte* diag, int* m, int* n, ComplexFloat* alpha, ComplexFloat* A, int* lda, ComplexFloat* B, int* ldb);
    ...
    /// <param name="B">Pointer to the matrix B.</param>
    /// <param name="ldb">Pointer to the leading dimension of the matrix B.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ztrsm")]
    internal static extern void Z_tr_sm(sbyte* side, sbyte* uplo, sbyte* transa, sbyte* diag, int* m, int* n, ComplexDouble* alpha, ComplexDouble* A, int* lda, ComplexDouble* B, int* ldb);
}
