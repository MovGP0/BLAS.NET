...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "strtri")]
    ...
    /// <param name="info">Pointer to the status of the operation.</param>
    /// <returns>An integer indicating the status of the operation.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "dtrtri")]
    ...
    /// <param name="info">Pointer to the status of the operation.</param>
    /// <returns>An integer indicating the status of the operation.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ctrtri")]
    ...
    /// <param name="info">Pointer to the status of the operation.</param>
    /// <returns>An integer indicating the status of the operation.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ztrtri")]
