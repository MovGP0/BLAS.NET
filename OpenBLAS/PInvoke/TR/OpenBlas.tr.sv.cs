...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "strsv")]
    ...
    /// <param name="x">Pointer to the right-hand side vector x.</param>
    /// <param name="incX">Pointer to the increment for the elements of x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "dtrsv")]
    ...
    /// <param name="x">Pointer to the right-hand side vector x.</param>
    /// <param name="incX">Pointer to the increment for the elements of x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ctrsv")]
    ...
    /// <param name="x">Pointer to the right-hand side vector x.</param>
    /// <param name="incX">Pointer to the increment for the elements of x.</param>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ztrsv")]
