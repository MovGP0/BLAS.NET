...
internal static unsafe partial class OpenBlas
{
    ...
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "isamin_")]
    ...
    /// <param name="incX">Pointer to the increment for the elements of the vector.</param>
    /// <returns>The index of the element with the minimum absolute value in the vector.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "idamin_")]
    ...
    /// <param name="incX">Pointer to the increment for the elements of the vector.</param>
    /// <returns>The index of the element with the minimum absolute value in the vector.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "icamin_")]
    ...
    /// <param name="incX">Pointer to the increment for the elements of the vector.</param>
    /// <returns>The index of the element with the minimum absolute value in the vector.</returns>
    [DllImport("libopenblas", CallingConvention = CallingConvention.Cdecl, EntryPoint = "izamin_")]
